...
public class TestShellSort {
    ...
    public static void main(String[] args) {
        ...
        for( int i = 0 ; i < T ; i ++ ) {
            ...
            time1 += SortTestHelper.testSort2("myalgo.ShellSort", arr1);
            time2 += SortTestHelper.testSort2("myalgo.MergeSort", arr2);
            time3 += SortTestHelper.testSort2("myalgo.QuickSort", arr3);
            time4 += SortTestHelper.testSort2("myalgo.QuickSort2Ways", arr4);
            time5 += SortTestHelper.testSort2("myalgo.QuickSort3Ways", arr5);
        }
